...
INSERT INTO `Has_passages` VALUES (1,2,'n'),(2,3,'w'),(2,5,'sw'),(2,7,'se'),(2,9,'n'),(3,2,'e'),(3,4,'n'),(4,3,'s'),(4,9,'ne'),(5,2,'sw'),(5,6,'se'),(5,8,'e'),(5,9,'nw'),(6,5,'nw'),(6,7,'s'),(6,8,'n'),(7,2,'nw'),(7,6,'n'),(8,5,'w'),(8,6,'s'),(9,2,'s'),(9,4,'sw'),(9,5,'se'),(9,10,'ne'),(9,11,'n'),(9,12,'nw'),(10,9,'sw'),(11,9,'sw'),(11,12,'w'),(12,9,'se'),(12,11,'e'),(12,13,'e'),(13,12,'w');
...
INSERT INTO `Items` VALUES (1,'Ride tickets',1,NULL,'tickets'),(2,'Stuffed Teddy Bear',2,NULL,NULL),(3,'Blue pencil',2,NULL,NULL),(4,'Funfair themed playing cards',2,NULL,NULL),(5,'Cup of coffee',3,NULL,'coffee'),(6,'Cup of tea',3,NULL,'tea'),(7,'Can of soda',3,NULL,'soda'),(8,'Bottle of water',3,NULL,'water'),(9,'Cinnamon bun',4,NULL,'bun'),(10,'Cookie',4,NULL,'cookie'),(11,'Chocolate brownie',4,NULL,'brownie'),(12,'Pink candy floss',5,NULL,'candy floss'),(13,'Candies',5,NULL,'candies'),(14,'Licorice',5,NULL,'licorice');
...
INSERT INTO `Line` VALUES (1,'There is bad blood around in our funfair. Walk around to find out!',8,1,NULL,NULL),(2,'You want to buy ride tickets? Okey, here you go.',8,1,1,NULL),(3,'Would you have guessed the clown is my mother? It feels like I\'ve live my whole life here. Sometimes I wonder about the meaning of life. I study philosophy.',8,1,NULL,NULL),(4,'My name is Elna and I\'m the funfair clown.',1,2,NULL,NULL),(5,'I’m proud of my parents. There isn’t many funfairs nowadays in Finland anymore. I’m bored but this is my life.',5,6,NULL,NULL),(6,'It’s such a nice day today. I think the kids will have a blast when I perform later. The janitor roasted some marshmallows last night.',1,2,NULL,NULL),(7,'My name Is Valter and I\'m the funfair magician. ',2,7,NULL,NULL),(8,'The magician looks at you and winks his eye. You don\'t really know what to think of him. ',2,7,NULL,NULL),(9,'I’m glad everything is going so smoothly today. I heard there is almost no crime in this town.',3,5,NULL,NULL),(10,'I think this place is really dull.',5,6,NULL,NULL),(11,'I think my cookies are excellent today. My name is Peter by the way.',6,12,NULL,NULL),(12,'Blah blah! My name is Sara.',5,6,NULL,NULL),(13,'I prefer dark roast when it comes to coffee.',6,12,NULL,NULL),(14,'I would love to cycle around this town. It’s the best when you go around a lot, you get to see new places and learn new magic tricks.',2,7,NULL,NULL),(15,'It seems a bit slower today. Maybe I will read today. I like to travel and sometimes I feel like travelling when exploring a new book!',1,2,NULL,NULL),(16,'You can come talk to me if you see a criminal.',3,5,NULL,NULL),(17,'I\'m Linda.',3,5,NULL,NULL),(18,'Oh my shoes! I\'d love to talk to you but it\'s so crazy here today.',4,3,NULL,NULL),(19,'Are you just like one of these vandals? Oh maybe not, you seem a bit older. I\'m Lena by the way. Sometimes I think I will have grey hair at the end of summer becouse all the reckless driving.',4,3,NULL,NULL),(20,'The bumper car operator is busy yells at some children. You think it\'s better not to bother her.',4,3,NULL,NULL),(21,'You know what\'s the purpose of reindeer? To make grass grow hehehe.',6,12,NULL,NULL),(22,'\"I\'m Matilda. \" The candy shop keeper says while arranging all the candy.',7,11,NULL,NULL),(23,'This is a cool place to work. Meet new people, see new places, eat lots of candy floss. I study geopgraphy. Won\'t really work for me as practical training for school but no worries.',7,11,NULL,NULL),(24,'I make excellent candy floss. You should try some.',7,11,NULL,NULL),(25,'I\'m Arthur. I wish the ferris wheel is repaired soon.',10,8,NULL,NULL),(26,'...',9,13,NULL,NULL);
...
INSERT INTO `Persons` VALUES (1,'Elna the Clown',1,2,NULL,'clown;the clown;pelle;elna;elna the clown'),(2,'The Magician',1,7,NULL,'valter'),(3,'Security Officer',1,5,NULL,'security'),(4,'Bumper Car Operator',1,3,NULL,'lena'),(5,'Carousel Operator',1,6,NULL,'sara'),(6,'Cafe Keeper',1,12,NULL,'peter; cafe keeper'),(7,'Candy Shop Keeper',1,11,NULL,'matilda; candy shop keeper'),(8,'Ticket Vendor',NULL,1,NULL,'edvin'),(9,'Funfair Director',NULL,13,NULL,'director; birgitta'),(10,'Ferris Wheel Operator',NULL,8,NULL,'arthur');
...
-- Dump completed on 2018-05-01 15:54:54
