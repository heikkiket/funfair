...
# Database: funfair
# Generation Time: 2018-05-03 07:33:04 +0000
# ************************************************************
...
VALUES
	(1,'Ride tickets',1,NULL,'tickets; ride tickets'),
	(2,'Stuffed Teddy Bear',2,NULL,NULL),
	(3,'Blue pencil',2,NULL,NULL),
	(4,'Funfair themed playing cards',2,NULL,NULL),
	(5,'Cup of coffee',3,NULL,'coffee; coffee cup; cup of coffee'),
	(6,'Cup of tea',3,NULL,'tea; tea cup; cup of tea'),
	(7,'Can of soda',3,NULL,'soda; can of soda; soda can; soda bottle; bottle of soda'),
	(8,'Bottle of water',3,NULL,'water; water bottle; bottle of water; '),
	(9,'Cinnamon bun',4,NULL,'bun; cinnamon bun'),
	(10,'Cookie',4,NULL,'cookie; chocolate cookie'),
	(11,'Chocolate brownie',4,NULL,'brownie; brownies; chololate brownie; chocolate brownies'),
	(12,'Pink candy floss',5,NULL,'candy floss; cotton candy; pink candy floss; pink cotton candy'),
	(13,'Candies',5,NULL,'candies; mixed candies; candy; mixed sweets; sweets'),
	(14,'Licorice',5,NULL,'licorice; loose licorice; piece of licorice');
...
VALUES
	...
	(2,'The Magician',1,7,NULL,'valter; the magician; magician; game keeper',0),
	(3,'Security Officer',1,5,NULL,'security, security officer; the security officer; linda',0),
	(4,'Bumper Car Operator',1,3,NULL,'lena; bumper operator, bumper cars operator, the bumper cars operator',0),
	...
	(9,'Funfair Director',NULL,13,NULL,'director; birgitta; funfair director; boss; the boss; the director',0),
