...
# Database: funfair
# Generation Time: 2018-05-07 09:43:45 +0000
# ************************************************************
...
INSERT INTO `Has_passages` (`Place_Id`, `Has_passagesPlace_Id`, `Direction_Id`, `Locked`, `Lock_message`)
VALUES
	(1,2,'n',0,NULL),
	(2,1,'s',0,NULL),
	(2,3,'w',0,NULL),
	...
	(12,9,'se',0,NULL),
	(12,11,'e',0,NULL),
	(12,13,'w',1,'Through cafe backdoors glass window you can see an empty campfire place and some stuff that looks a lot like funfair workers\' personal belongings. You try to reach the door, but Cafe Keeper yells you to come back.'),
	(13,12,'e',0,NULL);
...
VALUES
	...
	(18,'Bottle pyramid',13,'bottle pyramid'),
	(19,'Pull-a-string',13,'pull-a-string;pull string'),
	(20,'Climb the ladder',13,'climb ladder;');
...
INSERT INTO `Line` (`Lines_Id`, `Line_Text`, `Person_Id`, `Place_Id`, `Item_Id`, `Connects_Person_Id`, `Is_tip`, `Is_said`)
VALUES
	(1,'There is bad blood around in our funfair. Walk around to find out!',8,1,NULL,NULL,0,0),
	(2,'You want to buy ride tickets? Okey, here you go.',8,1,1,NULL,0,0),
	(3,'Would you have guessed the clown is my mother? It feels like I\'ve live my whole life here. Sometimes I wonder about the meaning of life. I study philosophy.',8,1,NULL,NULL,0,0),
	(4,'My name is Elna and I\'m the funfair clown.',1,2,NULL,NULL,0,0),
	(5,'I’m proud of my parents. There isn’t many funfairs nowadays in Finland anymore. I’m bored but this is my life.',5,6,NULL,NULL,0,0),
	(6,'It’s such a nice day today. I think the kids will have a blast when I perform later. The janitor roasted some marshmallows last night.',1,2,NULL,NULL,0,0),
	(7,'My name Is Valter and I\'m the funfair magician. ',2,7,NULL,NULL,0,0),
	(8,'The magician looks at you and winks his eye. You don\'t really know what to think of him. ',2,7,NULL,NULL,0,0),
	(9,'I’m glad everything is going so smoothly today. I heard there is almost no crime in this town.',3,5,NULL,NULL,0,0),
	(10,'I think this place is really dull.',5,6,NULL,NULL,0,0),
	(11,'I think my cookies are excellent today. My name is Peter by the way.',6,12,NULL,NULL,0,0),
	(12,'Blah blah! My name is Sara.',5,6,NULL,NULL,0,0),
	(13,'I prefer dark roast when it comes to coffee.',6,12,NULL,NULL,0,0),
	(14,'I would love to cycle around this town. It’s the best when you go around a lot, you get to see new places and learn new magic tricks.',2,7,NULL,NULL,0,0),
	(15,'It seems a bit slower today. Maybe I will read today. I like to travel and sometimes I feel like travelling when exploring a new book!',1,2,NULL,NULL,0,0),
	(16,'You can come talk to me if you see a criminal.',3,5,NULL,NULL,0,0),
	(17,'I\'m Linda.',3,5,NULL,NULL,0,0),
	(18,'Oh my shoes! I\'d love to talk to you but it\'s so crazy here today.',4,3,NULL,NULL,0,0),
	(19,'Are you just like one of these vandals? Oh maybe not, you seem a bit older. I\'m Lena by the way. Sometimes I think I will have grey hair at the end of summer becouse all the reckless driving.',4,3,NULL,NULL,0,0),
	(20,'The bumper car operator is busy yells at some children. You think it\'s better not to bother her.',4,3,NULL,NULL,0,0),
	(21,'You know what\'s the purpose of reindeer? To make grass grow hehehe.',6,12,NULL,NULL,0,0),
	(22,'\"I\'m Matilda. \" The candy shop keeper says while arranging all the candy.',7,11,NULL,NULL,0,0),
	(23,'This is a cool place to work. Meet new people, see new places, eat lots of candy floss. I study geopgraphy. Won\'t really work for me as practical training for school but no worries.',7,11,NULL,NULL,0,0),
	(24,'I make excellent candy floss. You should try some.',7,11,NULL,NULL,0,0),
	(25,'I\'m Arthur. I wish the ferris wheel is repaired soon.',10,8,NULL,NULL,0,0),
	(26,'I think I must thank you.',9,13,NULL,NULL,0,0),
	(27,'I like people who drink coffee. They are trustworthy. Here you go, enjoy!',6,12,3,NULL,0,0),
	...
	(35,'A MOOSE FROM THE LOCAL FOREST VISITED TOWN\'S ZOOLOGICAL MUSEUM',8,14,16,NULL,0,0),
	(36,'Postman beaten by lavander bush',8,14,16,NULL,0,0),
	(37,'Town\'s firefighters rescue duck from lake',8,14,16,NULL,0,0),
	(38,'Man\'s legs stolen - wedding dream shattered',8,14,16,NULL,0,0),
	(39,'Old man: I\'ve been posting my letter in the dog poo box for two years',8,14,16,NULL,0,0),
	(40,'Kitten chokes on mouse',8,14,16,NULL,0,0),
	(41,'yawning almost killed man',8,14,16,NULL,0,0),
	(42,'toilet curse strikes again',8,14,16,NULL,0,0),
	(43,'man who stabbed inflatable duck with scissors avoids jail',8,14,16,NULL,0,0),
	(44,'dealer sold tea to cops',8,14,16,NULL,0,0),
	(45,'dead man found in graveyard',8,14,16,NULL,0,0),
	(46,'Sure you can have a soda. Here you go.',6,12,8,NULL,0,0),
	(47,'Water water water...it\'n not even so hot in here, but here you go.',6,12,9,NULL,0,0),
	(48,'I have made this cinnamon buns myself. Hope you like it.',6,12,10,NULL,0,0),
	(49,'One brownie coming right up.',6,12,12,NULL,0,0),
	(50,'Oh so nice of you to buy some candy floss from me. Candy Shop Keeper smiles at you.',7,11,13,NULL,0,0),
	(51,'You buy a lot of candies.',7,11,14,NULL,0,0),
	(52,'Not everyone likes licorice. Here you go!',7,11,15,NULL,0,0),
	(53,'One cookie for you!',6,12,11,NULL,0,0),
	(54,'bugs flying around with wings are flying bugs',8,14,16,NULL,0,0),
	(55,'statistics show that teen pregnancy drops off significantly after age 25',8,14,16,NULL,0,0),
	(56,'Correction! Last week\'s ad should have read: \'see our huge selection of fun toys\'.. not \'boys\'',8,14,16,NULL,0,0),
	(57,'Hedman attorney accidentally sues himself',8,14,16,NULL,0,0),
	(58,'Ten commandments: surpreme court says some ok, some not',8,14,16,NULL,0,0),
	(59,'Police raid gun shop, find weapons',8,14,16,NULL,0,0),
	(60,'town unsure why the sewer smells',8,14,16,NULL,0,0),
	(61,'town population to double by 2030. Babies to blame.',8,14,16,NULL,0,0),
	(62,'Postman\'s speed fine got lost in the post',8,14,16,NULL,0,0),
...
INSERT INTO `Places` (`Place_Id`, `Name`, `Description`, `Details`, `Alias`, `Action`, `Description_night`, `Details_night`)
VALUES
	(1,'Ticket Office','You are at the Ticket Office.','The ticket office is near the entrance of the funfair. The ticket vendor is selling tickets. To the south there is exit but you don\'t want to leave just yet. To the north there seems to be some kind of stage.','ticket office',NULL,'You are at the ticket office.','Office is closed and looks a little bit scary with its dark windows.'),
	(2,'Open Air Stage','You are at the Open Air Stage.','There is Elna the clown at the open air stage.','stage;open air stage',NULL,'You are at the open air stage.','In stage you can feel a slight wind grabbing by your coat. A small mouse runs through the yard.'),
	(3,'Bumper Cars','You are at Bumper Cars.','There is a bumper car opetaror. She seems to be a bit angry to some teens who are all just hitting each other\'s cars.','bumper cars','You really want to try the bumper cars. You hit so many other cars while riding them. Luckily you live in a small town. Not so much traffic on the actual roads.','You are at Bumper Cars.','Bumper cars rest in their arena. Their shapes look like giant insects in the dark.'),
	(4,'Roller Coaster','You are at the Wormster.','Old man runs the roller coaster very slowly. He seems not to want to talk with you. The roller coaster itself seems smiley though, it looks like a green happy worm. ','roller coaster','You and a lot of kids queue for the Wormster. It seems a bit silly, but still so much fun. You ride the roller coaster and he track goes around three times. It certainly was worth the ride ticket!','You are at the Wormster.','The wormster is not scary even in the night.'),
	(5,'Security Station','You are now at the Security Station. ','The security station is a small booth with a red cross on the roof. There is a security officer.','security station',NULL,'You are now at the Security Station. ','The security station is closed. It looks dull even in the blue night light.'),
	(6,'Carousel','You are now at the Carousel.','There is a carousel operator working. She seems like a nice girl.','carousel','You get on the carousel. You almost cannot choose between a horse carriage and a spinning coffee cup, but finally you see a zebra and you enjoy the carousel ride riding it. What a ride!','You are now at the Carousel.','The carousel cranks silently by itself. Horses bend their necks endlessly.'),
	(7,'Game Hall','You are now at the Game Hall.','There is a lot of games to choose from. The magician seems to be managing all the games. You see at least Bottle Pyramid and Pull-A-String -games being played.','game hall;games',NULL,'You are now at the Game Hall.','The game hall is closed. You cannot get in. Pity: you\'d like to loot all the teddy bears.'),
	(8,'Ferris Wheel','You are at the Ferris Wheel. ','You see an old Ferris Wheel and want to jump in. It seems not to be working though. There is a mechanics working on it but they are too busy to notice you. On the ground there is a ferris wheel operator sitting and looking bored.','ferris wheel',NULL,'You are at the Ferris Wheel. ','The ferris wheel is lit and feels like welcoming you to take a ride. Why wouldn\'t you ask Funfair director Birgitta there with you?'),
	(9,'Food Court','You are at the Food Court.','To the north there is a Candy Shop, norhtwest Cafe, norhtheast Mirror Maze, southwest Rollercoaster, south open air stage and southeast Security Station.\n','food court',NULL,'You are at the Food Court.','Food court is closed and silent. There are some sleeping birds in the buildings.'),
	...
	(11,'Candy Shop','You are at the Candy Shop.','The candy shop keeper is chewing a licorice. She has big eyeglasses and pink hair. There is a lot of candies and loose licorice around you and a candy floss machine in the corner. ','candy shop',NULL,'You are at the Candy Shop.','Candy shop is closed. Its door looks weird: so funny at day, but now in the night feels like its sad from something.'),
	(12,'Cafe','You are at the Cafe. ','Everything smells so good you almost want to have a cup of coffee. There seems to be good looking cinnamon buns, cookies and brownies on the shelf as well. There is a cafe keeper. He seems happy and old.','cafe',NULL,'You are at the Cafe. ','Cafe is closed so you walk around it.'),
	(13,'Campfire','You are at the campfire behind the Cafe.','You are at the campfire. The cafe keeper yells you from the cafe to come back. The only way out is west back to the cafe.','campfire',NULL,'Campfire flames create a warm glow around.','All funfair staff members are gathered together around the fire.'),
	(14,'Warehouse','You are working hard here every night','You are working hard in here','work;warehouse','You work here','',NULL);
